python3  -u main.py --dataset=$1 --optimizer=$2  \
            ...
            # python  -u main.py --dataset=vehicle --optimizer=qffedavg --data_partition_seed=1 --q=0 --sampling=1 --output="./log_vehicle/qffedavg_samp2_run1_q5" --learning_rate=0.01 --learning_rate_lambda=0.01 --num_rounds=20 --eval_every=1 --clients_per_round=10 --batch_size=64 --model='svm' --num_epochs=1 --log_interval=10 --static_step_size=0 --track_individual_accuracy=0